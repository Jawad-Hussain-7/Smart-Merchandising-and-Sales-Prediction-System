...
export default class DefaultAdCard extends Component {
  ...
  onCardPress = () => {
      this.props.action(this.state.data, this.updateCard)
  }
      ...
      <TouchableOpacity onPress={this.onCardPress}>
        ...
        <View style={{ flex: 4, flexDirection: 'row' }}>
          <View style={{ flex: 4 }}>
            ...
            <View style={{ flex: 1, justifyContent: 'center' }}>
              <Text numberOfLines={1} ellipsizeMode={'tail'} style={this.styles.price}>Rs. {this.state.price} </Text>
            </View>
            <View style={{ flex: 1, justifyContent: 'center' }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
              <TouchableOpacity onPress={this.props.onDealPress}>
                <FontAwesome name={'dollar'} color={'#008080'} size={responsiveHeight(3.5)} />
              </TouchableOpacity>
            </View>
          </View>
        </View>
