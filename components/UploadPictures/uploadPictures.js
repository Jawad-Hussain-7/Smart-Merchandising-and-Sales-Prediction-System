...
export default class UploadPictures extends Component {
  ...
  render() {
    return (
      <Animatable.View style={{ flex: this.props.flexSize, height:this.props.height, width:this.props.width, borderRadius:this.props.radius }}>
        <TouchableOpacity style={{ flex: 1 }} onPress={this.openCamera}>
          <View style={{ flex: 1, backgroundColor: '#d1d1d1', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <View style={{ flex: 1 }}>
              <Text>Upload your {this.props.placeholder}</Text>
            </View>
          </View>
        </TouchableOpacity>
      </Animatable.View>
