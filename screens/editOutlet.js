...
import { getFirestoreUserByEmail, setStore, addStore, getStore, updateStore } from '../utility/firestoreUtility'
import { uploadStoreImages, deleteAdImage } from '../utility/storageUtility'
            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 11, alignItems: 'center' }}>
                    <ScrollView>
                        ...
                        <PostButton flexSize={1} buttonText={'REGISTER'} action={this.editOutlet} />
                    </ScrollView>
                </View>
            </View>
        )
