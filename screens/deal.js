...
import DealTypeRadioButton from '../components/DealTypeRadioButtons/DealTypeRadioButtons'
...
import { addOrder } from '../utility/firestoreUtility'
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                ...
                <KeyboardAvoidingView style={{ flex: 8, paddingVertical: responsiveHeight(6) }}>
                    <ScrollView style={{ flex: 1 }}>
                        ...
                        <Text style={{ fontSize: responsiveFontSize(2.3), textAlign: 'center', marginBottom: responsiveHeight(2.5) }}>Rs. {this.state.adData.docData['Price']}</Text>
