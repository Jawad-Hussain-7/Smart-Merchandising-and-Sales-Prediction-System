...
import { changePassword } from '../utility/authUtility'
    ...
    render() {
        return (
            <View style={{ flex: 1, }}>
                ...
                <InternalHeader action={() => { this.setState(this.initialState); this.props.navigation.goBack() }} name={'Change Password'} flexSize={0.7} />
